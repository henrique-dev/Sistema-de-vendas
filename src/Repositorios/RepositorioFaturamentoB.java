...
public class RepositorioFaturamentoB {
    
    private ArrayList<Faturamento> lista;
    private ArrayList<Faturamento> tempLista;
    private static RepositorioFaturamentoB instanciaRep;
    
    private RepositorioFaturamentoB(){
        this.lista = new ArrayList<Faturamento>();
    }
    
    public static RepositorioFaturamentoB obterInstancia(){
        if(instanciaRep == null)
        {
            instanciaRep = new RepositorioFaturamentoB();
        }
        return instanciaRep;   
    }
    ...
    public ArrayList<Faturamento> listar() throws SQLException{
        ...
        try{            
            ...
            String temp = "SELECT * FROM FAT_BOMBONS";
    ...
    public int getId(Connection con) throws SQLException {         
        String SEQ = "SELECT NEXTVAL('SEQ_FATB')";
        int id = 0; 
        try {             
    ...
    public void inserir(Faturamento faturamento) throws  Exception{        
            ...
            for(int x=0;x<this.lista.size();x++){
                ...
                if(data.equals(lista.get(x).getData())){
                    ...
                    */                    
                    ...
                    String temp = "UPDATE FAT_BOMBONS SET DATA=? ,VALOR=? WHERE ID=?";
        ...
        if(novo){
        String temp = "INSERT INTO FAT_BOMBONS(ID,DATA,VALOR) VALUES(?,?,?)";
        PreparedStatement prepared = con.prepareStatement(temp);
    ...
    public void setEstoque(Double saldo,char op){
        ...
        String temp = "UPDATE SALDO SET ESTOQUE_BOMBONS=?";
        PreparedStatement prepared = con.prepareStatement(temp);
    ...
    public String getEstoque() throws SQLException{
        ...
        try{            
            ...
            while(result.next()){                
                saldo = (result.getString("ESTOQUE_BOMBONS"));
